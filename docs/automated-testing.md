...
tests/e2e/responsive-places-layout.spec.mjs  Cross-breakpoint map/list geometry, touch targets, and singular controls
tests/e2e/visual.spec.mjs        Reviewed signed-out, map, and saved-place-list visual baselines
