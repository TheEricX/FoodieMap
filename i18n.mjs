export const translations = {
  en: {
    "boot.eyebrow": "FOODIEMAP",
    "boot.loading": "Loading your map…",
    "app.brand": "Gourmet Map",
    "app.sharedBrand": "Shared Bite",
    "nav.map": "Map",
    "nav.places": "My Places",
    "nav.lists": "Lists",
    "nav.recipes": "Recipes",
    ...
    "search.lists": "Search this list and its restaurants...",
    ...
    "auth.closeDialog": "Close sign-in dialog",
    ...
    "paste.help": "Paste a Google or Apple Maps link to fill the details automatically.",
    ...
    "maps.inboundIntro": "A Maps link was sent to FoodieMap. Review the details, then save this place.",
    "maps.clipboardIntro": "Found a Maps link in your clipboard. Review the detected details, then save this place.",
    ...
    "button.addSpot": "+ Add a place",
    "button.addRecipe": "+ Add recipe",
    "button.addRestaurant": "Add a restaurant",
    "button.pasteMapsLink": "Paste a Maps link",
    "button.addToMyList": "+ Add to My List",
    "button.pasteAdd": "Paste & Add",
    "places.eyebrow": "MY PLACES",
    "places.title": "Your saved places",
    "places.viewLabel": "Places view",
    "places.map": "Map",
    "places.list": "List",
    ...
    "button.edit": "Edit",
    "button.share": "Share",
    "button.sharePrivate": "Share privately",
    "button.delete": "Delete",
    "button.remove": "Remove",
    "button.save": "Save",
    "button.cancel": "Cancel",
    "button.backToRecipes": "All recipes",
    ...
    "button.markVisited": "Mark visited",
    "button.view": "View",
    "button.done": "Done",
    "spot.markedVisited": "Marked as visited.",
    "button.close": "Close",
    "button.openMap": "Open on Map",
    "button.openMaps": "Directions",
    "button.viewAllPlaces": "View all places",
    ...
    "map.emptyFavoriteTitle": "No favorites yet",
    "map.emptyFavoriteBody": "Mark a place as Favorite to keep it in this quick-access list.",
    "map.emptyFilterTitle": "No places in this filter",
    "map.emptyFilterBody": "Try another category or view all your saved places.",
    ...
    "list.noFavoriteSpots": "No favorite places yet. Mark a place as Favorite to find it quickly here.",
    ...
    "list.addSpotMode": "ADD TO LIST",
    "list.addSpotTitle": "Add restaurant to a list",
    "list.addSpotHelp": "Choose a private list for this restaurant.",
    "list.addSpotNoLists": "Create your first list to organize this restaurant.",
    "list.createForSpot": "Create a new list",
    "list.creatingWithSpot": "This restaurant will be added when you save the list.",
    "list.createdWithSpot": "Added {name} to {title}.",
    "list.spotAdded": "Added {name} to {title}.",
    "list.created": "List created.",
    "list.updated": "List updated.",
    "list.quickCaptureHelp": "Name the list now. Add a description or cover later.",
    ...
    "list.saving": "Saving...",
    "list.loading": "Loading your lists...",
    "list.published": "List published to Discovery.",
    "list.unpublished": "List is private again.",
    ...
    "spot.saved": "Restaurant saved.",
    "spot.updated": "Restaurant updated.",
    "spot.quickCaptureHelp": "Paste a map link, confirm the name, and save it for later.",
    "spot.addDetails": "Add details",
    "spot.hideDetails": "Hide details",
    ...
    "share.help": "Choose menu items to show, then generate a public link, QR code, and image card.",
    "share.noDishes": "This spot has no menu items yet. You can still share the restaurant details.",
    "share.link": "Share link",
    "share.linkPlaceholder": "Link appears after creation",
    "share.cardAlt": "Restaurant QR code share card",
    ...
    "recipes.systemIcon": "System image",
    "recipes.systemIconHelp": "Using the selected system image. Upload a photo to replace it.",
    "recipes.iconFood": "Food",
    "recipes.iconNoodles": "Noodles",
    "recipes.iconRice": "Rice",
    "recipes.iconSalad": "Salad",
    "recipes.iconDessert": "Dessert",
    "recipes.iconDrink": "Drink",
    "recipes.iconGrill": "Grill",
    ...
    "recipes.quickCaptureHelp": "Save the dish name now and fill recipe details whenever you have time.",
    "recipes.save": "Save Recipe",
    "recipes.saving": "Saving recipe…",
    ...
    "settings.mapAppLabel": "Preferred map app",
    "settings.mapAppSystem": "Ask every time",
    "settings.appearanceEyebrow": "APPEARANCE",
    "settings.appearanceTitle": "App theme",
    "settings.appearanceHelp": "Choose how your restaurant journal looks on this device.",
    "settings.themePaper": "Paper journal",
    "settings.themePaperDescription": "Warm, calm and familiar.",
    "settings.themeDeepDive": "Deep-sea log",
    "settings.themeDeepDiveDescription": "Night dives, sonar panels and bright catch tags.",
    "settings.themeIzakaya": "Izakaya night",
    "settings.themeIzakayaDescription": "Lantern light, dark timber and menu paper.",
    "settings.themePartyIsland": "Party island",
    "settings.themePartyIslandDescription": "Blue skies, playful panels and bright rewards.",
    ...
    "admin.description": "Manage account access, plans, restaurant limits, and photo quotas.",
    ...
    "admin.imageLimit": "Photos {count}/{limit}",
    "admin.photoLimit": "Photo limit",
    "admin.saveLimit": "Save",
    "admin.usePlanDefault": "Use plan default",
    "admin.imageLimitInvalid": "Enter a whole-number photo limit from 0 to 10000, or leave it blank to use the plan default.",
  ...
  zh: {
    ...
    "paste.help": "粘贴 Google 或 Apple Maps 链接，即可自动填写地点详情。",
    ...
    "maps.inboundIntro": "已收到来自地图的链接。请核对信息后保存这家餐厅。",
    "maps.clipboardIntro": "已从剪贴板找到地图链接。请核对识别到的信息后保存这家餐厅。",
    ...
    "button.newSpot": "+ 新餐厅",
    "button.addSpot": "+ 添加地点",
    "button.addRecipe": "+ 添加菜谱",
    "button.addRestaurant": "添加餐厅",
    "button.pasteMapsLink": "粘贴地图链接",
    "button.addToMyList": "+ 加入我的列表",
    "button.pasteAdd": "粘贴并添加",
    "places.eyebrow": "我的地点",
    "places.title": "已保存的地点",
    "places.viewLabel": "地点视图",
    "places.map": "地图",
    "places.list": "列表",
    "button.export": "导出",
    "button.import": "导入",
    ...
    "button.edit": "编辑",
    "button.share": "分享",
    "button.sharePrivate": "私密分享",
    "button.delete": "删除",
    "button.remove": "移除",
    "button.save": "保存",
    "button.cancel": "取消",
    "button.backToRecipes": "全部菜谱",
    "button.continue": "继续",
    "button.discard": "放弃更改",
    "button.signOut": "退出登录",
    "button.copy": "复制",
    ...
    "button.google": "Google",
    "button.add": "添加",
    "button.addToList": "加入清单",
    "button.markVisited": "标记去过",
    "button.view": "查看",
    "button.done": "完成",
    "spot.markedVisited": "已标记为去过。",
    "button.close": "关闭",
    "button.openMap": "在地图打开",
    "button.openMaps": "导航",
    "button.viewAllPlaces": "查看全部地点",
    ...
    "map.emptyFavoriteTitle": "还没有最爱餐厅",
    "map.emptyFavoriteBody": "将一家餐厅标记为「最爱」，它就会出现在这个快捷分类中。",
    "map.emptyFilterTitle": "这个分类里还没有餐厅",
    "map.emptyFilterBody": "试试其他分类，或查看全部已保存的地点。",
    ...
    "list.noFavoriteSpots": "还没有最爱餐厅。将一家餐厅标记为「最爱」，就能在这里快速找到它。",
    ...
    "list.addSpotMode": "加入清单",
    "list.addSpotTitle": "把餐厅加入清单",
    "list.addSpotHelp": "选择一个私密清单来保存这家餐厅。",
    "list.addSpotNoLists": "先创建第一个清单，再整理这家餐厅。",
    "list.createForSpot": "创建新清单",
    "list.creatingWithSpot": "保存清单时会同时加入这家餐厅。",
    "list.createdWithSpot": "已将 {name} 加入 {title}。",
    "list.spotAdded": "已将 {name} 加入 {title}。",
    "list.created": "清单已创建。",
    "list.updated": "清单已更新。",
    "list.quickCaptureHelp": "先保存清单名称，描述和封面可以以后再补。",
    "list.editHelp": "修改会立即影响我的清单；公开清单会同步更新发现页展示。",
    "list.titleRequired": "请输入清单标题。",
    "list.saving": "正在保存...",
    "list.loading": "正在加载你的清单...",
    "list.published": "清单已发布到 Discovery。",
    "list.unpublished": "清单已恢复为私密。",
    ...
    "spot.saved": "餐厅已保存。",
    "spot.updated": "餐厅已更新。",
    "spot.quickCaptureHelp": "粘贴地图链接，确认店名后立即保存，其他信息可以以后再补。",
    "spot.addDetails": "补充信息",
    "spot.hideDetails": "收起补充信息",
    ...
    "share.mode": "分享",
    "share.title": "分享这家餐厅",
    "share.help": "选择要展示的菜单项，然后生成公开链接、二维码和分享图。",
    "share.noDishes": "这家店还没有菜单项，也可以先分享餐厅信息。",
    "share.link": "分享链接",
    "share.linkPlaceholder": "生成后显示链接",
    "share.cardAlt": "餐厅二维码分享图",
    "sharePack.mode": "私密分享",
    ...
    "recipes.systemIcon": "系统图片",
    "recipes.systemIconHelp": "正在使用所选系统图片。上传照片后会替换它。",
    "recipes.iconFood": "通用",
    "recipes.iconNoodles": "面食",
    "recipes.iconRice": "米饭",
    "recipes.iconSalad": "沙拉",
    "recipes.iconDessert": "甜点",
    "recipes.iconDrink": "饮品",
    "recipes.iconGrill": "烧烤",
    ...
    "recipes.quickCaptureHelp": "先保存菜名，食材、步骤和照片可以以后再补。",
    "recipes.save": "保存菜谱",
    "recipes.saving": "正在保存菜谱…",
    "recipes.updated": "菜谱已更新。",
    "recipes.update": "更新菜谱",
    "recipes.saved": "菜谱已保存。",
    ...
    "settings.mapAppLabel": "默认地图应用",
    "settings.mapAppSystem": "每次询问",
    "settings.appearanceEyebrow": "外观",
    "settings.appearanceTitle": "界面皮肤",
    "settings.appearanceHelp": "选择这台设备上的餐厅日志风格。",
    "settings.themePaper": "纸张日志",
    "settings.themePaperDescription": "温暖、安静，保留熟悉的手账感。",
    "settings.themeDeepDive": "深海日志",
    "settings.themeDeepDiveDescription": "夜潜、声呐面板和醒目的收获标签。",
    "settings.themeIzakaya": "日式居酒屋",
    "settings.themeIzakayaDescription": "灯笼暖光、深色木框和菜单纸张。",
    "settings.themePartyIsland": "欢乐岛派对",
    "settings.themePartyIslandDescription": "蓝天、轻快面板和鲜明奖励色。",
    ...
    "admin.eyebrow": "后台",
    "admin.title": "用户管理",
    "admin.description": "管理账号访问、套餐、餐厅额度和图片额度。",
    ...
    "admin.imageLimit": "图片 {count}/{limit}",
    "admin.photoLimit": "图片额度",
    "admin.saveLimit": "保存",
    "admin.usePlanDefault": "使用套餐默认值",
    "admin.imageLimitInvalid": "请输入 0 到 10000 的整数图片额度，或留空使用套餐默认值。",
